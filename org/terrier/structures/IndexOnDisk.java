...
/**
 * The replacement for what was Index in earlier Terrier versions. Represents
 * the most common type of index, i.e. one which is stored on disk.
 * 
		...
		if (MAJOR_VERSION < MINIMUM_INDEX_TERRIER_VERSION)
		{
			if (MAJOR_VERSION == 3)
			{
				...
				logger.warn(this.toString() + " is a Terrier " + versionString
				        + " index - temporarily upgrading. Use "
				        + Terrier4.class.getName()
